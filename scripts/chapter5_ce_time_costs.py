#!/usr/bin/env python3
"""
chapter5_ce_time_costs.py

Redo the Chapter 5 / inflation-by-age "time cost" analysis using BLS Consumer
...
Outputs:
  ...
  figures/Chapter5/time_costs_ce_age_lines_by_cohort_2024.pdf/png
  figures/Chapter5/time_costs_ce_age_latest_stacked_hours_2024.pdf/png
  figures/Chapter5/time_costs_ce_age_25to34_breakdown_area_2024.pdf/png
  figures/Chapter5/time_costs_ce_age_education_spending_by_age_2024.pdf/png
  figures/Chapter5/time_costs_ce_age_latest_2024.tex

Run:
  python scripts/chapter5_ce_time_costs.py --anchor-year 2024 --start-year 1980
"""
...
def write_summary(panel: pd.DataFrame, anchors: pd.DataFrame, out_path: Path, anchor_year: int, plot_start_year: int) -> None:
    ...
    lines = []
    lines.append(f"Chapter 5 CE-based time-cost redo, anchor year {anchor_year}")
    lines.append("")
